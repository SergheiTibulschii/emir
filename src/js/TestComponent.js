...
const Step = ({ handleAnswer, stepName, data, answer }) => (
    <div className="mb-6">
        <h2 className="text-f3 mb-8">{data.title}</h2>
        {data.payload.map((d) => (
            <div
...
const Success = () => (
    <div className="mb-c5">
        <h2 className="title mb-8">Отлично!</h2>
        <p className="text-f3 mb-4">
    ...
    return (
        <Modal>
            <Modal.Head>
                ...
                <div className="flex relative items-center rounded-lg px-10 flex-1">
                    <div
